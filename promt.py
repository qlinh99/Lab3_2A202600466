...
COMPARISON_PROMPTS = [
    {
        ...
        "label": "Tinh tong don hang nhieu buoc",
        "prompt": (
            "Tôi muốn mua 2 iPhone 15, áp mã giảm giá WINNER và giao đến Hà Nội. "
            "Hãy tính tổng tiền cuối cùng gồm giá sản phẩm, giảm giá và phí ship."
        ),
